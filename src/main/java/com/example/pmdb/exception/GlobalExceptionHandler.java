...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleJsonParseException(JsonParseException ex) {
        ...
        ApiError body = new ApiError("JSON_PARSE_ERROR",
                "The request could not be parsed as a valid JSON.", ex.getLocalizedMessage());
...
//        logger.error("There is no entity with this parameter: ", ex);
//        HttpStatus status = HttpStatus.NOT_FOUND;
//
//        ApiError body = new ApiError("ENTITY_NOT FOUND",
//                "There is no entity with this parameter.", ex.getLocalizedMessage());
//
//        return new ResponseEntity<>(body, status);
//    }
...
//        logger.error("There is no registered user with this username: ", ex);
//        HttpStatus status = HttpStatus.NOT_FOUND;
//
//        ApiError body = new ApiError("ENTITY_NOT FOUND",
//                "There is no registered user with this username.", ex.getLocalizedMessage());
//
//        return new ResponseEntity<>(body, status);
//    }
//
...
//        logger.error("You have no appropriate role to execute this action: ", ex);
//        HttpStatus status = HttpStatus.BAD_REQUEST;
//
//        ApiError body = new ApiError("ACCESS_DENIED",
//                "You have no appropriate role to execute this action.", ex.getLocalizedMessage());
//
//        return new ResponseEntity<>(body, status);
//    }
